...
<div class="container mt-5">
    <h1 class="text-center text-danger">Resenhas de Séries</h1>
    <div class="table-responsive mt-4">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                // Consulta para listar apenas séries
                $sql = "SELECT id, titulo, data_lancamento, diretor, temporadas FROM resenhas WHERE tipo = 'serie' ORDER BY data_lancamento DESC";
                ...
                ?>
                    <tr>                        
                        <td><?= htmlspecialchars($resenha['titulo']) ?></td>
                        <td><?= date("d/m/Y", strtotime($resenha['data_lancamento'])) ?></td>
                        <td><?= htmlspecialchars($resenha['temporadas']) ?></td>
                        <td>
                ...
                ?>
                    <tr>
                        <td colspan="6" class="text-center">Nenhuma resenha de séries encontrada.</td>
                    </tr>
                <?php
                endif;
